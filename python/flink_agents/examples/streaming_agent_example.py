...
if __name__ == "__main__":
    ...
    output_datastream = (
        agents_env.from_datastream(input=deserialize_datastream, key_selector=lambda x: x.get_id())
        .apply(MyWorkflow())
        .to_datastream()
    )

    output_datastream = output_datastream.map(lambda x: x + " after map")
